...
prop.table(table(moldova$ever_deten.f, moldova$sexM.f, useNA = 'ifany'), 1)
prop.table(table(moldova$ever_deten.f, moldova$homeless.f, useNA = 'ifany'), 1)
prop.table(table(moldova$ever_deten.f, moldova$rural.f, useNA = 'ifany'), 1)
prop.table(table(moldova$ever_deten.f, moldova$jobcat.f, useNA = 'ifany'), 1)
prop.table(table(moldova$ever_deten.f, moldova$edu.f, useNA = 'ifany'), 1)
prop.table(table(moldova$ever_deten.f, moldova$hiv.f, useNA = 'ifany'), 1)
